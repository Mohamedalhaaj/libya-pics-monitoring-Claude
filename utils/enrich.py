...
def _build_system_prompt() -> str:
    ...
    return (
        ...
        "House style (match the PICS \"Libya News Headlines\" report exactly):\n"
        "- Prefix a headline with the speaker's role/title in square brackets "
        "when it reports a named person's statement, e.g. \"[HoR Member] Jehani: "
        "the General Command's support gives the US initiative momentum\" or "
        "\"[Mufti] Gharyani issues a fatwa calling on Libyans to reject the "
        "outcomes\".\n"
        "- Beyond the suggested subsections, you MAY create a short event-specific "
        "subsection heading to cluster a major running story, e.g. \"Libyan "
        "governing institutions agree to hold elections before February 2027\" or "
        "\"HoR members show support for US proposal\".\n"
        "- Keep each headline to a single, factual sentence; do not start with the "
        "outlet name; preserve proper nouns and transliterations of Libyan names.\n"
        "- Order sources within a headline with English-language outlets first "
        "where natural, joined by \" / \" at render time.\n\n"
